...
public class jTPCCTData {
    ...
    protected long transDue;
    protected long transStart;
    protected long transEnd;
    protected boolean transRbk;
    private String transError;

    private int terminalWarehouse = 0;
    private int terminalDistrict = 0;

    protected NewOrderData newOrder = null;
    ...
    protected boolean useStoredProcedures = false;
    protected int dbType = jTPCCConfig.DB_UNKNOWN;
	...
	*/
    ...
    protected void executeNewOrderStoredProcPostgres(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
	...
	*/
    ...
    protected void executeNewOrderStoredProcOracle(Logger log, jTPCCConnection db)
            throws Exception {
    ...
    protected void executePayment(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
    ...
    protected void executePaymentStoredProcPostgres(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
        Connection conn = db.getConnection();
    ...
    protected void executePaymentStoredProcOracle(Logger log, jTPCCConnection db)
            throws Exception {
        CallableStatement stmt;
        Connection conn = db.getConnection();
    ...
    protected void executeOrderStatus(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
        Vector<Integer> c_id_list = new Vector<Integer>();
    ...
    protected void executeOrderStatusStoredProcPostgres(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
        Connection conn = db.getConnection();
    ...
    protected void executeOrderStatusStoredProcOracle(Logger log, jTPCCConnection db)
            throws Exception {
        CallableStatement stmt;
        Connection conn = db.getConnection();
        try {
    ...
    protected void executeStockLevel(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
    ...
    protected void executeStockLevelStoredProcPostgres(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
        Connection conn = db.getConnection();
    ...
    protected void executeStockLevelStoredProcOracle(Logger log, jTPCCConnection db)
            throws Exception {
        Connection conn = db.getConnection();
        CallableStatement stmt;
        try {
    ...
    protected void executeDelivery(Logger log, jTPCCConnection db) {
    ...
    protected void executeDeliveryBG(Logger log, jTPCCConnection db)
            throws Exception {
    ...
    protected void executeDeliveryBGStoredProcPostgres(Logger log, jTPCCConnection db)
            throws Exception {
        PreparedStatement stmt;
        ResultSet rs;
        Connection conn = db.getConnection();
    ...
    protected void executeDeliveryBGStoredProcOracle(Logger log, jTPCCConnection db)
            throws Exception {
        CallableStatement stmt;
        Connection conn = db.getConnection();
        try {
