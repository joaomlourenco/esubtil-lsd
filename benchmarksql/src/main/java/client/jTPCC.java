...
public class jTPCC implements jTPCCConfig {
    ...
    private long newOrderCounter = 0, sessionStartTimestamp, sessionEndTimestamp, sessionNextTimestamp = Long.MAX_VALUE,
    ...
    public jTPCC() {
        ...
        try {
            ...
            Driver drv = new lsd.Driver();
            DriverManager.registerDriver(drv);
        } catch (IOException e) {
            errorMessage("Term-00, could not load properties file");
        } catch (Exception e) {
            errorMessage("Error loading properties: " + e + ": " + e.getMessage());
        }
        ...
        log.info("Term-00,  (c) 2020-2021, Eduardo Subtil");
        log.info("Term-00, +-------------------------------------------------------------+");
        log.info("Term-00, ");
        ...
        log.info("Term-00, ");
        log.info("Term-00, Available Drivers:");
        Enumeration<Driver> driverList = DriverManager.getDrivers();
        while (driverList.hasMoreElements()) {
            log.info("Term-00, " + driverList.nextElement().getClass());
        }
        ...
        if (databaseDriverLoaded) {
            try {
                ...
                try {
                    ...
                    errorMessage("Error when loading wareHouses: " + e + ": " + e.getMessage());
                    e.printStackTrace();
                    throw e;
                }
